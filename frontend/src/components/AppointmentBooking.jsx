// frontend/src/components/AppointmentBooking.jsx (Enhanced with Real-time Updates)
...
function AppointmentBooking({ onBookingComplete }) {
  ...
  return (
    <div>
      ...
      {success && (
        <div className="mb-6 p-4 bg-green-50 border-2 border-green-200 text-green-700 rounded-xl flex items-center animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div
                    ...
                    className={`p-5 rounded-xl border-2 cursor-pointer transition-all duration-200 ${
                      selectedDoctor?._id === doctor._id
                        ? 'border-cyan-600 bg-gradient-to-r from-cyan-50 to-blue-50 shadow-lg scale-105'
                      ...
                      <button
                        ...
                        className={`py-3 px-4 rounded-xl border-2 text-sm font-semibold transition-all duration-200 ${
                          formData.time === slot
                            ...
                            : 'bg-white text-gray-700 border-gray-300 hover:border-cyan-300 hover:shadow-md'
                        }`}
                      >
                        {slot}
                      </button>
        ...
        {/* Selected Doctor Info & Guidelines */}
