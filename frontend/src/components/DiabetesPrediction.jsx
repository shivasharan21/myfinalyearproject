      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-800">
            ...
            <p>
              Use the test buttons to automatically fill the form with sample
              data for different risk profiles. This helps you quickly test the
              prediction model.
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-xs text-blue-800">
                  <strong>Note:</strong> This prediction is based on machine
                  learning analysis and should not replace professional medical
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-6">
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 text-sm">
                  Fill in the form to get your diabetes risk prediction
                </p>
              </div>
            </div>
          )}
